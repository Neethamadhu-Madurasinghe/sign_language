...
video_path = './inputs/'
output_dir = './all_outputs/output_combined'
video_files = []
    ...
    with mp_holistic.Holistic(
        ...
        with mp_hands.Hands(
            ...
            while cap.isOpened():
                ...
                if results_holistic.face_landmarks and results_holistic.pose_landmarks:
                    ...
                    print("Error: Could not extract landmarks using holistic model")
                ...
                if results_hands.multi_hand_landmarks:
                    ...
                    print("Error: Could not extract hand landmarks")               
